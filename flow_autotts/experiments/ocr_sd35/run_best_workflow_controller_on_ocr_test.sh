...
LAUNCH_LOG="${FLOW_TTS_LAUNCH_LOG:-${RUN_ROOT}/launcher.log}"
...
echo "[flow_autotts ocr workflow best controller eval] CONTROLLER_PATH=${CONTROLLER_PATH}"
echo "[flow_autotts ocr workflow best controller eval] CONTROLLER_KEY=${CONTROLLER_KEY}"
echo "[flow_autotts ocr workflow best controller eval] RUN_ROOT=${RUN_ROOT}"
echo "[flow_autotts ocr workflow best controller eval] TEST_SAMPLE_SEED=${TEST_SAMPLE_SEED}"
echo "[flow_autotts ocr workflow best controller eval] DEVICES=${DEVICES}"
