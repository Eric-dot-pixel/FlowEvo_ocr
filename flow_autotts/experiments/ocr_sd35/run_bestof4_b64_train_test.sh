...
CANDIDATES="${FLOW_TTS_CANDIDATES:-4}"
...
TRAIN_ROOT="${REPO_ROOT}/logs/flow_autotts/ocr_sd35/bestof4_b64_train"
TEST_ROOT="${REPO_ROOT}/logs/flow_autotts/ocr_sd35/bestof4_b64_test"
...
python -m flow_autotts.experiments.ocr_sd35.bestof4_baseline \
  "${COMMON_ARGS[@]}" \
  --split train \
